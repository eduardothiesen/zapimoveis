...
/**
 * Created by eduardothiesen on 07/04/17.
 */

class RealtyDetailsLoader extends AsyncTaskLoader<Response> {

    private final static String LOG_TAG = RealtyDetailsLoader.class.getName();

    private String url;

    public RealtyDetailsLoader(Context context, String url) {
        super(context);
        this.url = url;
    }
